...
// Full list of products with updated images as per user request (using Picsum/Placehold)
const PRODUCTS = [
    // Electronic Devices
    {
    ...
    },
    {
        ...
        price: 12000,
        category: "Electronic Accessories",
        image: "https://placehold.co/600x600?text=Anker+PowerCore", // UPDATED LINK
        brand: "Anker",
        rating: 4.6,
    ...
    },
    {
        ...
        price: 3200,
        category: "Health & Beauty",
        image: "https://picsum.photos/seed/serum/600", // UPDATED LINK
        brand: "The Ordinary",
        rating: 4.7,
    ...
    // Babies & Toys
    {
        ...
        image: "https://picsum.photos/seed/pampers/600", // UPDATED LINK
        brand: "Pampers",
        rating: 4.8,
    ...
    },
    {
        ...
        price: 8000,
        category: "Babies & Toys",
        image: "https://picsum.photos/seed/lego/600", // UPDATED LINK
        brand: "LEGO",
        rating: 4.9,
    ...
    },
    {
        ...
        price: 2200,
        category: "Groceries & Pets",
        image: "https://picsum.photos/seed/catfood/600", // UPDATED LINK
        brand: "Whiskas",
        rating: 4.7,
    ...
    },
    {
        ...
        price: 8500,
        category: "Home & Lifestyle",
        image: "https://picsum.photos/seed/cooking/600", // UPDATED LINK
        brand: "Chef",
        rating: 4.4,
    ...
    },
    {
        ...
        price: 3000,
        category: "Home & Lifestyle",
        image: "https://picsum.photos/seed/pillow/600", // UPDATED LINK
        brand: "MoltyFoam",
        rating: 4.5,
    ...
    // START Just For You Items - ensuring updated images here too where titles match
    {
    ...
    },
    {
        ...
        brand: "Generic",
        rating: 4.6,
        description: "Comfortable over-ear headphones delivering immersive sound and deep bass."
    },
    {
        title: "Smartwatch",
        price: 5500,
        category: "Electronic Devices",
        image: "https://picsum.photos/seed/smartwatch/600", // UPDATED LINK
        brand: "Generic",
        rating: 4.4,
    ...
    },
    {
        ...
        brand: "Generic",
        rating: 4.8,
        description: "Durable mechanical keyboard with RGB backlighting and tactile switches for gaming and typing."
    },
    {
        title: "Gaming Mouse",
        price: 3000,
    ...
    },
    {
        ...
        brand: "Generic",
        rating: 4.5,
        description: "Compact Bluetooth speaker with powerful sound and water resistance for outdoor use."
    },
    {
        title: "Action Camera",
        price: 12000,
        category: "Electronic Devices",
        image: "https://picsum.photos/seed/camera/600", // UPDATED LINK
        brand: "Generic",
        rating: 4.6,
        description: "Capture your adventures in 4K with this rugged and waterproof action camera."
    },
    {
        title: "VR Headset",
        price: 25000,
    ...
    },
    {
        ...
        brand: "Generic",
        rating: 4.9,
        description: "Professional DSLR camera for stunning photography and video recording."
    },
    {
        title: "Tablet / iPad",
        price: 45000,
        ...
        brand: "Generic",
        rating: 4.7,
        description: "Versatile tablet perfect for work, entertainment, and creativity on the go."
    },
    {
        title: "Powerbank",
        price: 3500,
        category: "Electronic Accessories",
        image: "https://picsum.photos/seed/battery/600", // Matches requested "Power Bank (Slim)" image
        brand: "Generic",
        rating: 4.6,
        description: "High-capacity powerbank to keep your devices charged throughout the day."
    },
    {
        title: "USB-C Hub",
        price: 2500,
        ...
        brand: "Generic",
        rating: 4.5,
        description: "Multi-port USB-C hub for expanding connectivity on your laptop or tablet."
    },
    {
        title: "Drone with Remote",
        price: 65000,
        category: "Electronic Devices",
        image: "https://images.unsplash.com/photo-1507582020474-9a35b7d455d9?q=80&w=800&auto=format&fit=crop",
        brand: "Generic",
        rating: 4.8,
        description: "Advanced drone with 4K camera and stable flight controls for aerial photography."
    },
    {
        title: "Laptop Stand",
        price: 2000,
        category: "Electronic Accessories",
        image: "https://picsum.photos/seed/stand/600", // UPDATED LINK
        brand: "Generic",
        rating: 4.4,
        description: "Ergonomic laptop stand to improve posture and airflow for your device."
    },
    {
        ...
        brand: "Generic",
        rating: 4.6,
        description: "Voice-controlled smart assistant for managing your home and daily tasks."
    }
];
...
const importData = async () => {
    try {
        ...
        console.log('Clearing ALL existing products to prevent duplicates...');
        await Product.deleteMany({});
        console.log('Database cleared.');

        console.log(`Inserting ${PRODUCTS.length} updated products...`);
